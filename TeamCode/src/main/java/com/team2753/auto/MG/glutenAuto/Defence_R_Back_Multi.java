...
@Autonomous(name = "Red Back Big Boy Defense", group = "Defence")
@Disabled
public class Defence_R_Back_Multi extends AutoModeBase {

    @Override
    public void runOpMode() throws InterruptedException {
        waitForStart("RBack Defence");
        ...
        switch (WhatColumnToScoreIn()){
            case RIGHT:
                ...
                Robot.getDrive().encoderDrive(0.4, (Constants.WHEEL_BASE*PI*(20))/180, 0, 3);
